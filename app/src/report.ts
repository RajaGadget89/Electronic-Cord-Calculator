...
---
*หมายเหตุ: เครื่องมือนี้ช่วยประเมินเบื้องต้น ไม่ใช่เอกสารรับรองทางวิศวกรรม*
สร้างโดย ${CREATOR}
`;
}
...
${warn}
<div class="foot">เครื่องมือช่วยประเมินเบื้องต้น ไม่ใช่เอกสารรับรองทางวิศวกรรม · สร้างโดย ${CREATOR}</div>
</body></html>`;
}
